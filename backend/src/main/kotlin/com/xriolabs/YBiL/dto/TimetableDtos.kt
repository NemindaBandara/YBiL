...
data class CreateRouteRequest(
        @field:NotBlank(message = "Route number cannot be blank") val routeNumber: String,
        @field:NotBlank(message = "Origin cannot be blank") val origin: String,
        @field:NotBlank(message = "Destination cannot be blank") val destination: String
)
...
data class CreateTimetableEntryRequest(
        @field:NotNull(message = "Route ID is required") val routeId: UUID,
...
data class TimetableEntryResponse(
        ...
        val busCategory: BusCategory,
        val busNumber: String?,
        @JsonFormat(pattern = "HH:mm") val scheduledParkingTime: LocalTime,
        @JsonFormat(pattern = "HH:mm") val scheduledLeavingTime: LocalTime,
